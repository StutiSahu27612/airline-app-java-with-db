PAYLOAD="$(cat <<EOF
{
  "audience": "//iam.googleapis.com/projects/maximal-brace-436007-t5/locations/global/workloadIdentityPools/airline-javaapp-pool/providers/airlineapp-provider",
